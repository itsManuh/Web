...
CREATE TABLE `detalles_ordenes` (
  `idDetallesOrden` bigint unsigned NOT NULL AUTO_INCREMENT,
  `idOrden` int DEFAULT NULL,
  `idProducto` int DEFAULT NULL,
  `monto` int DEFAULT NULL,
  `cantidadProductos` int DEFAULT NULL,
  PRIMARY KEY (`idDetallesOrden`),
  UNIQUE KEY `idDetallesOrden` (`idDetallesOrden`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ordenes` (
  ...
  `monto` int DEFAULT NULL,
  `ordenDireccion` varchar(50) DEFAULT NULL,
  `ordenEmail` varchar(50) DEFAULT NULL,
  `ordenFecha` varchar(50) DEFAULT NULL,
  `ordenStatus` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`idOrden`),
...
-- Dump completed on 2022-12-30 17:28:51
